...
public class WeatherFragment extends Fragment {
    ...
    TextView cityField,updateField,detailsField,currentTemperatureField,tempMin,tempMax,weatherIcon;
    Handler handler;
    ...
    private void renderWeather(JSONObject json) {
        ...
        try {
            ...
            currentTemperatureField.setText("Temperature : "+Double.toString(main.getDouble("temp"))+ " *C");
            tempMin.setText("Min Temp : "+Double.toString(main.getDouble("temp_min"))+ " *c");
            tempMax.setText("Max Temp : "+Double.toString(main.getDouble("temp_max"))+ " *c");
